...
export default function FilterBar() {
  const { search, minPrice, maxPrice, setFilter, reset } = useFilterStore()
    ...
    <div className="flex flex-wrap items-center gap-3 px-gutter py-4 border-b border-outline-variant bg-surface">
      <div className="relative">
        ...
        <input
          ...
          className="pl-8 pr-3 py-2 text-sm border border-outline-variant rounded-lg bg-white focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 w-72"
        />
      </div>
